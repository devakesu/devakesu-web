...
export const EFFECTIVE_DATE = '09-02-2026';
...
* **Google Signals is enabled**, which means Google may:
  ...
  * Store cookies in your browser (\`_ga\`, \`_gid\`) for tracking purposes
...
* **Content:** Personal writings, project descriptions, and images are © ${new Date().getFullYear()} Devanarayanan
...
**Google Analytics Cookies (Active by Default):**
Google Analytics sets the following cookies in your browser:

* **\_ga** - Main cookie for distinguishing unique users
  * **Duration:** 2 years
...
* **\_gid** - Distinguishes users
  * **Duration:** 24 hours
  * **Type:** First-party, persistent
  * **Purpose:** Short-term user tracking
  
* **\_ga\_[container-id]** - Session state persistence
  * **Duration:** 2 years
  * **Type:** First-party, persistent
  * **Purpose:** Store and count page views

**Google Signals Additional Tracking:**
If you're signed into Google, additional cookies may be set for cross-device tracking and ads personalization.

**No Other Cookies Set by This Site:**
...
* **Essential:** None. This site functions without any cookies.
* **Optional:** Google Analytics cookies (_ga, _gid, etc.)
